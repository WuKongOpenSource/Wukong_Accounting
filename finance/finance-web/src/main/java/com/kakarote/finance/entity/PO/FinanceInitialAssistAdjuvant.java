...
@TableName("wk_finance_initial_assist_adjuvant")
@ApiModel(value = "FinanceInitialAssistAdjuvant对象", description = "财务初始余额管理辅助核算表")
public class FinanceInitialAssistAdjuvant implements Serializable {
